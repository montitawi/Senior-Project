...
# Node ID 3000
export NODE_ID=3000
OUTPUT1=$(./blockchain_pow createwallet)
OUTPUT2=$(./blockchain_pow createwallet)
echo "${OUTPUT1}"
echo "${OUTPUT2}"
...
./blockchain_pow send -from ${addr1} -to ${tempnode3001addr0} -amount 251 -mine
...
export NODE_ID=3002
export node3002Miner=$(./blockchain_pow createwallet | egrep -o "\w+$")
